...
ところが，トキポナUDにおいては，この，文を受けるniに関する係り受けは必ず，非交差条件を満たさないことがわかっています．
図でも，'ni'と':'の間の部分で矢印が交差しているのが確認できます．

'ni'が文を受けると非交差条件を満たさなくなるのは，以下の２点が原因です．
- 従属節が内容を表しており，その主辞がそれを受けるniに係ること
- 従属節を切り分ける約物の':'が主文の主辞に係るとしたこと

従属節の主辞を主文の主辞とする，つまり，この場合は'tawa -> ike'とすると，非交差条件を満たすことになります．
しかし，この場合，従属節は副詞修飾やなんらかの節として修飾すると解釈をせざるをえません．
実際には，トキポナにおけるniが受ける従属節は，必ずniの内容を述べることになり，これは非交差条件を満たすためだけに妥協した解釈と言わざるをえません．

約物の':'が，主文の主辞'tawa'に係っているため，非交差条件が満たされていないとも言えます．
':'の係り先を'ni'とすれば，この問題は解決されます．
しかし，':'は，'ni'が従属節を切り離す役割をしているのではなく，主文が従属節を切り離しているとみなすのが自然です．
この点で，':'の主辞は文の主辞とするべきです．
また，仮に':'の主辞が'ni'であったとしても，次の例のように'e ni tan lipu:'のような形になった場合は，結局の所，非交差条件が破られてしまいます．

以上の理由で，敢えて非交差条件を満たすために自然な解釈を捨てようとしても，なかなかかんたんには行かず，文を受けるniについては非交差条件は満たされないものとするのがよいと考えています．
ただ，nymwaさんが考えただけのトキポナUDが最善のものとは思えず，より良い解釈や係り受けもあり得るため，これからも改善を続けたいと思います．
なんかいい感じのがあったら教えてください≡╹ω╹≡．
...
どれだけ構文がかんたんであっても，否定の意味，疑問の意味，限定の意味などを表すこととなり，
順序・一致・支配などが一定の規則を満たすことでなんらかの意味が表されるのだという枠組みから，外れることはできません．
そして，それらを厳密に記述しようという試みは，十分な知識や経験がなければ，決してかんたんではないのだろうと思います．
これは，言語がそもそも難しいということが原因なのかなと思います．
トキポナUDをやって，そのことをより強く実感しました．
...
個人的にも，他の言語でのUDを記述してみたいなと思っています．アラズ語とか．シャレイア語UDは割とやりたい．
