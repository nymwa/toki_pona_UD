...
この例も，述語が２つあります．いずれも述語は動詞句で，１つ目の動詞句に副詞修飾があるのみで，これまで説明した内容で理解できます．

## lipu loje, tomo sina, tawa sewi, moku mute, pona kute

![lipu loje](./image/lipu_loje.png)
![tomo sina](./image/tomo_sina.png)
![tawa sewi](./image/tawa_sewi.png)
![moku mute1](./image/moku_mute1.png)
![moku mute2](./image/moku_mute2.png)
